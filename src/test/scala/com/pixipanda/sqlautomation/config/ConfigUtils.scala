...
object ConfigUtils {
  ...
  val job1QueryConfig1: QueryConfig = QueryConfig(1, None, "SELECT * FROM employeeView where emp_dept_id = 10", None, TRANSFORM)
  val job1QueryConfig2: QueryConfig = QueryConfig(2, None, "SELECT * FROM db.table2", Some("Job1view2"), TRANSFORM)
  ...
  val job3QueryConfig1: QueryConfig = QueryConfig(1, None, "SELECT * FROM test_db1.employee", Some("employeeView"), TRANSFORM)
  val job3QueryConfig2: QueryConfig = QueryConfig(2, None, "SELECT * FROM employeeView where emp_dept_id = 10", Some("Job3view2"), TRANSFORM)
